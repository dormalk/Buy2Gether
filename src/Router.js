    ...
    return(
        <Router>
            <Scene key="root" hideNavBar duration={0}>
                <Scene key="auth" duration={0} navigationBarStyle={{ backgroundColor: '#5aba1f', height: 0}} renderBackButton={() => (null)}  renderLeftButton={()=>(null)}>
                    <Scene key="login" duration={0} component={LoginForm} initial/>
                    <Scene key="ragister" duration={0} component={RagisterForm}/>
                </Scene>
                <Scene key="main" duration={0} navigationBarStyle={{ backgroundColor: '#5aba1f', height: 0}} renderBackButton={() => (null)} renderLeftButton={()=>(null)}>
